...
@Component({
  selector: 'nga-diagnostic-category-selector',
  template: `
      <label for="categories" translate>Category</label>
...
export class DiagnosticCategorySelectorComponent implements OnInit {
